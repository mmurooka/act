    ...
    def __init__(self, backbones, transformer, encoder, num_queries, camera_names, use_tactile=False):
        ...
        if backbones is not None:
            ...
            if self.use_tactile:
                ...
                self.tactile_input_proj_robot_state = nn.Linear(16 * self.TACTILE_NUM_NODES, hidden_dim)
        else:
        ...
        if self.use_tactile:
            ...
            #     in_features=32, out_features=64, num_nodes=self.TACTILE_NUM_NODES, edge_index=self.TACTILE_EDGE_IDX)
            self.tactile_proj = nn.Linear(16 * self.TACTILE_NUM_NODES, hidden_dim)  # project tactile to embedding
